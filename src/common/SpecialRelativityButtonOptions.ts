/**
 * SpecialRelativityButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = SpecialRelativityColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link SpecialRelativityColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SPECIAL_RELATIVITY_COMBO_BOX_OPTIONS = {
  buttonFill: SpecialRelativityColors.controlSurfaceColorProperty,
  listFill: SpecialRelativityColors.controlSurfaceColorProperty,
  buttonStroke: SpecialRelativityColors.panelBorderColorProperty,
  listStroke: SpecialRelativityColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: SpecialRelativityColors.textColorProperty },
  },
